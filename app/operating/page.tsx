...
export default function Home() {
    ...
    return (
        <>
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6">
                                                <div className="col-lg-10">
                                                    <p className="font-bold lg:text-[2.5vw] text-[4.5vw] lg:leading-[3.5vw] leading-[5.5vw] lg:pt-[130px] pt-[30px] text-[#212833]">Get a tailored Operating Agreement for your LLC</p>
                                                    <p className="text-[#232323] lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] lg:pt-[20px] pt-[30px] ">
                                                    Set the foundation for your LLC’s success with doola’s comprehensive Operating Agreement service. Whether you’re launching a new venture or refining the operations of an existing LLC, an Operating Agreement is essential to maintain clarity and structure.</p>
                                                    <p className="text-[#232323] lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] lg:pt-[20px] pt-[30px] ">
                                                    Operating Agreements are included in all of our business formation packages and can get you setup quickly and effortlessly.</p>
                        ...
                        <div className="col-lg-6 lg:pt-[60px] pt-[20px]">
                            <div className="flex ">
                                <div className="col-lg-12">
                                    ...
                                    <div className="col-lg-9">
                                        <p className="text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] "><span className=" font-medium">Clarity and Structure:</span>Operating Agreements are included in all of our business formation packages and can get you setup quickly and effortlessly.
                                        </p>
                        ...
                        <div className="lg:pt-[80px] pt-[10px]">
                            <div className="row ">
                                <div className="col-lg-6 lg:pt-[60px] pt-[20px] order-lg-1 order-2">
                                    <div className="flex ">
                                        <div className="col-lg-12">
                                            <p className="text-[#010202]   font-semibold lg:text-[2vw] text-[4vw] lg:leading-[2.5vw] leading-[5vw] ">What should an Operating Agreement include?</p>
                                            ...
                                            <ul className="list-disc text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium ">
                                                <li className="mt-2">Basic Information about the LLC</li>
                                                <li className="mt-2">Membership Information</li>
                                                <li className="mt-2">Financial Information about the LLC</li>
                                                <li className="mt-2">Management information
                                                </li>
            ...
            <section className="lg:px-[100px] px-[20px] mb-4 lg:pt-[80px] pt-[20px] overflow-hidden ">
                <div className="row">
                    <div className="col-lg-12">
                        <div className="lg:flex">
                            <div className="col-lg-6 mb-4">
                                <div className="col-lg-6 ">
                                    ...
                                    <p className="lg:text-[1.8vw] text-[4vw] lg:leading-[1.8vw] leading-[5vw] font-bold lg:pt-[20px] pt-[10px]">Operating Agreement Service</p>

                                </div>
                                <div className="col-lg-9 mb-4">
                                    <p className="lg:text-[0.9vw] text-[3.3vw] lg:leading-[1.2vw] leading-[4.2vw]">Operating Agreements are included in all of our business formation packages and can get you setup quickly and effortlessly.</p>
                            ...
                            <div className="col-lg-6 mb-4 flex lg:justify-end justify-center">
                                <div className="col-lg-7 rounded-xl bg-[#F6F6F6]">
                                    <div className="lg:pt-[20px] pt-[10px] flex gap-4 lg:px-5 px-3 ">
                                        <Image
                                            ...
                                            height={750}
                                        />
                                         <p className="lg:text-[1vw]  text-[4vw] m-0 pt-2 font-medium ">Operating Agreement</p>
                                        
                                    </div>
                                    <ul className="list-disc mt-4 font-medium">
                                            <li>Tailored Operating Agreement for your business</li>
                                            <li>Expert review to ensure compliance</li>
