                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="col-lg-10">
                                        <p className="font-bold lg:text-[2.5vw] text-[4.5vw] lg:leading-[3.5vw] leading-[5.5vw] lg:pt-[130px] pt-[30px] text-[#212833]">Get a Registered Agent for your business today</p>
                                        <p className="text-[#232323] lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] lg:pt-[20px] pt-[10px] ">
                                            Receive timely alerts for legal documents, government notices, and essential correspondence, so you can respond quickly and manage your business confidently. Ensure 100% compliance and avoid potential legal penalties. Signup with Cloud BSS for just $297 per year.</p>
                ...
                <div className="col-md-12 lg:pt-[80px] pt-[10px]">
                    <div className="row ">
                        ...
                        <div className="col-lg-6 lg:pt-[60px] pt-[20px]">
                            <div className="flex ">
                                <div className="col-lg-12">
                                    <p className="text-[#010202]   font-semibold lg:text-[2vw] text-[4vw] lg:leading-[2.5vw] leading-[5vw] ">Does my business need a Registered Agent?</p>
                                    <p className="text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] ">Yes. Every business entity is required to have an official Registered Agent in each state where it conducts business.
                                    </p>
                                    <div className="col-lg-9">
                                        <p className="text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] ">A Registered Agent provides a permanent physical presence in the state, serving as the official address where the state government can send legal and tax correspondence. This includes franchise tax forms, notices of litigation, and required annual report forms.
                                        </p>
                                        <p className="text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] ">Registered Agents ensure timely receipt and handling of these documents, helping businesses stay compliant with state regulations and legal obligations. Additionally, having a Registered Agent helps maintain the privacy of business owners by using the agent’s address for public records instead of the owner’s personal address.

                                        </p>

                                    </div>
                                    <ul className="list-disc text-[#404040] lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium ">
                                        <li>Required for LLCs, corporations, and nonprofits to meet state laws</li>
                                        <li>Having an official point of contact for legal matters is essential</li>
                                        <li>Reliable physical address and availability for receiving documents</li>
                        ...
                        <div className="lg:pt-[80px] pt-[10px]">
                            <div className="row ">
                                <div className="col-lg-6 lg:pt-[60px] pt-[20px] order-lg-1 order-2">
                                    <div className="flex ">
                                        <div className="col-lg-12">
                                            <p className="text-[#010202]   font-semibold lg:text-[2vw] text-[4vw] lg:leading-[2.5vw] leading-[5vw] ">Can I be my own Registered Agent?</p>
                                            <div className="col-lg-11">
                                                <p className="text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] ">Technically, yes, but there are several reasons why it might not be the best choice:
                                                </p></div>
                                            <div className="col-lg-11">
                                                <p className="text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] "><span className=" font-medium">Legal Compliance:</span>  Many states mandate that businesses have a Registered Agent. Failing to comply could result in penalties or even the dissolution of your business.

                                                </p>
                                                <p className="text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] "><span className=" font-medium">Physical Presence: </span>Registered Agents must have a physical address in the state of operation. If you move or change locations frequently, this could be challenging.

                                                </p>
                                                <p className="text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] "><span className=" font-medium">Timely Receipt:  </span> Registered Agents ensure prompt delivery of important documents, helping you stay on top of legal obligations. Managing this yourself could lead to missed deadlines and legal consequences.
                                                </p>
                                                <p className="text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] "><span className=" font-medium">Expertise and Reliability:   </span> Professional Registered Agents are experienced in handling legal documents and can provide reliable service. Managing this yourself may require significant time and effort, and mistakes could have serious consequences.
                                                </p>
                                            </div>

                                            <ul className="list-disc text-[#404040]  lg:text-[1vw] text-[3vw] lg:leading-[1.5vw] leading-[4vw] font-medium ">
                                                <li className="mt-2">Am I organized enough? </li>
                                                <li className="mt-2">Am I tied to one location from 8 am until 5 pm, five days a week?</li>
                                                <li className="mt-2">Do I have a reputation to protect? </li>
                        ...
                        <div className="lg:flex">
                            <div className="col-lg-6 mb-4">
                                <div className="col-lg-6 ">
                                    ...
                                    <p className="lg:text-[1.8vw] text-[4vw] lg:leading-[1.8vw] leading-[5vw] font-bold lg:pt-[20px] pt-[10px]">Registered Agent Service</p>

                                </div>
                                <div className="col-lg-9 mb-4">
                                    <p className="lg:text-[0.9vw] text-[3.3vw] lg:leading-[1vw] leading-[4.2vw]">Get your Cloud BSS Registered Agent service today for reliable management of all your legal and official document needs.</p>
                                    <p className="lg:text-[0.9vw] text-[3.3vw] lg:leading-[1vw] leading-[4.2vw]">NOTE: Registered Agent is free with Cloud BSS Formation Service.</p>


                                </div>
                            </div>

                            <div className="col-lg-6 mb-4 pt-4 flex lg:justify-end justify-center">
                                <div className="col-lg-8 rounded-xl bg-[#F6F6F6]">
                                    <div className="lg:pt-[20px] pt-[10px] flex gap-2 lg:px-5 px-3 ">
                                        <Image
                                            ...
                                            height={750}
                                        />
                                        <p className="lg:text-[1.1vw] text-center font-semibold text-[4vw] m-0 pt-2">Registered Agent</p>

                                    </div>
                                    
                                    <div className="col-lg-12 p-2 mt-2">
                                    <ul className="list-disc  font-medium">
                                        <li className="mt-1">Receive local document scans within the same day and enjoy secure storage for all scanned documents</li>
                                        <li className="mt-1">Commitment to privacy protection</li>
                                        <li className="mt-1">Timely notifications for annual reports</li>

                                    </ul>
                                    </div>
                                    <div className="flex justify-between items-center px-4 ">
                                    <p className="lg:text-[1.1vw] text-center font-semibold text-[4vw]">$297  <span className="font-normal">per year</span></p>
                                    <div className=" flex items-center lg:justify-end justify-center  mb-4 ">
